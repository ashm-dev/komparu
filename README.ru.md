...
### Сравнение файлов: различие в последнем байте
...
Зелёный = komparu быстрее. Нижняя строка показывает, как quick_check обнаруживает различие в последнем байте 1GB-файла в **12 000x** быстрее, чем filecmp.
...
|----------|--------|---------|---------|--------|----|------|
| идентичные | 1MB | 310us | 453us | 1.45ms | 2.22ms | 2.05ms |
| идентичные | 10MB | 5.12ms | 5.53ms | 6.82ms | 6.76ms | 11.45ms |
| идентичные | 100MB | 41ms | 57ms | 80ms | 36ms | 44ms |
| идентичные | 1GB | 285ms | 379ms | 341ms | 291ms | 302ms |
| различие в конце | 1MB | 53us | 441us | 1.03ms | 1.17ms | 1.01ms |
| различие в конце | 10MB | 46us | 5.89ms | 6.47ms | 5.97ms | 5.77ms |
| различие в конце | 100MB | 46us | 58ms | 36ms | 31ms | 32ms |
| различие в конце | 1GB | 30us | 373ms | 346ms | 295ms | 303ms |

**Сравнение директорий**

| Сценарий | komparu | filecmp | Go | Rust |
|----------|---------|---------|-----|------|
| 100 файлов x 1MB, идентичные | 14ms | 42ms | 34ms | 32ms |
| 100 файлов x 1MB, 1 отличается | 14ms | 41ms | 36ms | 37ms |
| 1000 файлов x 100KB, идентичные | 24ms | 54ms | 42ms | 38ms |
